...
translate turkish strings:
    ...
    old "Menu"
    new "Menü"
# TODO: Translation updated at 2020-09-11 22:51

translate turkish strings:

    # game/screens.rpy:570
    old "Made with {a=https://www.renpy.org/}Ren'Py{/a} [renpy.version_only] and ZL-Games. Thanks: Pitrik; Mormont; Ozel; Kir_Laurentis; Kytronix and Alfa.omega.\n\n[renpy.license!t]"
    new "\nDiscord adresimiz için: {a=https://discord.gg/XsKNAub}ADULT OYUN ÇEVİRİ DİSCORD{/a}\n\n{a=https://www.renpy.org/}Ren'Py{/a} [renpy.version_only].[renpy.license!t] ile yapıldı."
